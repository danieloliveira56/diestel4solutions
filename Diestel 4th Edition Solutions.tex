...
%Now consider the subgraph $H := (V,M)$, we have $d_H(v) = 1$ for each $v \in A'\cup B'$. 
%Then each extra $A'-B'$ edge simultaneously increase the degree of a vertex in $A'$ and one in $B'$, but an extra $(A\setminus A')-B'$ edge increase the degree of an edge in $B'$ but not in $A'$, thus
%\begin{align*}
%|E(A',B \setminusB')| > d(A\setminus A').
%\end{align*}
%
%
...
%vertex sets and a set O of vertex sets of complete subgraphs such that
%A = V (G) =
%
